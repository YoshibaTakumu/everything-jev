...
- Before starting/resuming work, operating on branches or PRs, or changing agent workflow, read the relevant [development policy](docs/dev-policy/README.md). Carry forward the task's existing authorization through its requested delivery point.
